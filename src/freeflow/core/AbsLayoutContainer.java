...
public abstract class AbsLayoutContainer extends ViewGroup {
     ...
     * @param positionInSection The position of the view in the adapter.
    ...
    public interface OnItemClickListener {
         ...
         * @param proxy  The view within the AdapterView that was clicked (this
    ...
    public interface OnItemSelectedListener {
         ...
         * @param proxy  The FreeFlowItem instance representing the item selected
         */
    ...
    public interface OnItemLongClickListener {
         ...
         * @param positionInSection The position of the view in the list
         * @param id                The row id of the item that was clicked
